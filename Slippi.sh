...
wget https://github.com/project-slippi/slippi-launcher/releases/download/v2.5.1/Slippi-Launcher-2.5.1-x86_64.AppImage

# Make the AppImage executabled
chmod a+x Slippi-Launcher-2.5.1-x86_64.AppImage

# Rename and move the AppImage to the binary directory
mv Slippi-Launcher-2.5.1-x86_64.AppImage Slippie-Launcher-x86_64.AppImage
